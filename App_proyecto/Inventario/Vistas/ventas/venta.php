  ...
  <div class="wrapper fixed-left">
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <a href="../producto/producto.php"><i class='bx bxs-shopping-bags'></i> Productos (ARREGLAR)</a>
        </li>
        <li>
          <a href="../usuario/usuario.php"><i class='bx bxs-user'></i> Usuarios (ARREGLAR)</a>
        </li>
        <li>
          <a href="venta.php"><i class='bx bxs-bar-chart-alt-2'></i> Ventas<br> (ARREGLAR)</a>
        </li>
        <li>
